...
<div id='body'>
	...
	<a id='big_buton' href='onas.php'>О Нас</a>
		<font>
			...
			<b><a id='more' href='onas.php'>Продолжение...</a></b>
		</font>
	</div>
	<div id='foto'>
	...
	?>
	<b><a id='more' href='foto.php'>Больше фотографий здесь</a></b>
	</div>
	<div id='knopi'>
...
<div id='text'>
	<font><p>  Для кого-то Новый год это семейный ужин, для кого-то это встреча со старыми друзьями, а кто-то хочет увидеть как от встречи с дедом морозом у детей загораются глаза и дом наполняется их звонким счастливым смехом! И сколько бы нам небыло лет, и где, и скем бы мы не праздновали,нас всех объединяет одно волшебное чувство - ожидание новогоднего чуда. Оно загорается искоркой в наших сердцах с детства,кода мы первый раз читаем стихотворение Дедушке морозу у горящей множеством огоньков новогодней ёлки и больше никогда не гаснет. </p>
		...
		Просто позвоните 8(950)021-15-58 и расскажите, где вы хотите видеть доброго
